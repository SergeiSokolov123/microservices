...
@Tag(name = "Контролер для банковских счетов")
public class AccountDetailsController {
     ...
     */
    @GetMapping("/{id}")
    @Tag(name = "Получение информации о банковском счете по id")
    @Operation(summary = "Поиск по ID и вывод информации по банковскому аккаунту")
     ...
     */
    @PostMapping("/create")
    @Tag(name = "Создание банковского счета")
    @Operation(summary = "Создание и вывод банковского счета")
    ...
    @Tag(name = "Обновление банковского счета")
    @Operation(summary = "Обновление и вывод банковского счета по ID")
     ...
     */
    @GetMapping("read/all")
    @Tag(name = "Получение нескольких банковских счетов по ID")
    @Operation(summary = "Поиск и вывод нескольких банковских счетов по ID")
